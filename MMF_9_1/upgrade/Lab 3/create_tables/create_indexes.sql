...
REFERENCES PALYLIST(ID) ON DELETE SET NULL;
...
CREATE INDEX FK_LISTENING_HISTORY_ALBUM ON LSITENING_HISTORY(ALBUM_ID) TABLESPACE &&INDEX_TABLESPACE;
...
ALTER TABLE USER_PLAYLIST ADD CONSTRAINT FK_USER_PLAYLIST_PLAYLIST FOREIGN KEY(PALYLIST_ID)
